...
function InputQuery({ sendMessage }) {
  ...
  return (
    ...
    >
      <label className="bg-[#e7ecf1] dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-800 p-2 rounded-full w-full flex items-center justify-between">
        <input
          type="text"
        ...
        <button
          type="submit"
          className="bg-[#3b82f6] p-4 rounded-full text-white hover:bg-blue-600 transition-colors duration-200 flex items-center justify-center"
        >
